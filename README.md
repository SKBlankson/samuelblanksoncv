...
<head>
	...
	<title>Samuel Blankson CV</title>
	<style>
		body {background-color: white;font-family: Arial, sans-serif;}
		h1   {color: #323b4c; font-family: Arial, sans-serif;} 
		p    {color: red;}
		img {border-radius: 50%}

		.mainbody {display: flex;margin: auto; width: 60%;}
		
		.leftside {flex: 1;background:#323b4c; color: white;padding-inline-start: 30px;padding-top: 20px;position: relative;align-content: stretch;}
        
        .rightside {float:right;background:lightblue;width:61.4%;height:100%;padding-inline-start: 30px;padding-top: 20px;align-content: stretch;}
        
        #profilepic img {display: block;margin: 0 auto;}
        
        .leftcontent {padding: 10px;}

        .rightcontent {padding: 10px;}
        
        .leftheader {padding: -5px;}
        
        h2.leftheader {color: white; font-family: Arial, sans-serif;}
        
        h2.rightheader {padding: 5px; color: #323b4c; padding-bottom: -15px}
        
        hr.lefthr {border-top: 1px solid white;margin-left: 5px;width:98%;margin-top: -15px;line-height: 0}
        
        hr.righthr {;margin-left: 5px;width:98%;margin-top: -15px; background-color: #323b4c; border-color: #323b4c}
       .
       overlay {width: 100%;z-index: 1;}
...
<div class="mainbody">
	<div class="leftside">
		<div id="profilepic" style="align-items: center;"><img src="sb_profile.jpg" style="width:60%" alt="Samuel's Profile Picture" ></div>
		...
		<div class="leftheader"><h2>Skills </h2></div>
		<hr class="lefthr">
	...
	<div class="rightside">
		...
		<div class="rightcontent"><b>Ashesi University <br>Game Development - Software Developer</b> <br> Oct 2022 - Dec 2022 <br><br>
			<ul>
